  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "h-7 w-7 bg-transparent p-0 flex items-center justify-center text-obsidian-500 hover:text-obsidian-900 transition-colors duration-300 z-20 pointer-events-auto",
        button_next: "h-7 w-7 bg-transparent p-0 flex items-center justify-center text-obsidian-500 hover:text-obsidian-900 transition-colors duration-300 z-20 pointer-events-auto",
